...
class WIKGMIL(MIL):
    def __init__(
        ...
        **kwargs,
        ...
        # Renamed '_fc1' to 'patch_embed' for consistency; optional Mammoth when moe_args specifies num_experts
    ...
    def forward_attention(
        self, h: torch.Tensor, attn_only: bool = False, **kwargs
        ...
        ka_weight = torch.einsum(
            "bnik,bnik->bni", gate, Nb_h
    ...
    def forward_features(
        self, h: torch.Tensor, attn_mask: torch.Tensor = None
    ) -> torch.Tensor:
        """
